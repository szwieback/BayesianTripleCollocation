...
def simulate_product(n, params, numpy_rng=None, seed=123):
    ...
    paramssim['thetaoffset'] = params['thetaoffset'] if 'thetaoffset' in params else 0.2
    ...
    if paramssim['spline']:
        ...
        nfackappa = nfacmu = nfaclambda = nsegments = params['nsegments_spline'] if 'nsegments_spline' in params else 12
