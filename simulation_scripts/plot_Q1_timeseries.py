...
ind_products=[1]
n_points = 151
ind_traces=[101, 501, 301]#[1,101,201,401,501,901,233]#[301,501]#[1,101,201,401]#1,2
show_traces = [1]
xrange=(0,366)
...
def ylab(ax,lab1,lab2):
    ax.text(-0.28, 0.5, lab1, transform = ax.transAxes, rotation='vertical',ha='right', va='center')
    ax.text(-0.19, 0.5, lab2, transform = ax.transAxes, rotation='vertical',ha='right', va='center')
